...
class _HomeHealthCareState extends State<HomeHealthCare> {
  ...
  void initState() {
    httpClient = Client();
    ethClient = Web3Client('http://ip address here:port number', httpClient);
    healthInfo = HealthInfo(
        name: 'Doctor',
        gender: 'M',
        age: 30,
    ...
    return SafeArea(
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed:()async{
            final result = await healthInfo.addNewRecord(ethClient, 'New Record 1', patientAddressS, myAddressS, privateKeyS);
            print(result);
          }
        ),
      ),
